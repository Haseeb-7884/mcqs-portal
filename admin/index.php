...
if (isset($_POST['submit_record'])) {
    ...
    $updatingStatus = $UsersObjEdit->update("profile", array(
        "status" => $status,
    ), "user_id = $userID");

    if (!empty($updatingUsers) && !empty($updatingStatus)) {
        header("location: index.php?RequestFarward=EditUsers&CurrentStatus=updated");
    }
} else {
    echo null;
}
if (isset($_POST['delete_record'])) {
    ...
    $role = $_POST['role'];
    $status = $_POST['status'];
    $updatingUsers = $UsersObjEdit->deletion("users", "id = $userID");

    if (!empty($updatingUsers)) {
        header("location: index.php?RequestFarward=EditUsers&CurrentStatus=deleted");
    }
} else {
    echo null;
}
if (isset($_GET['submission'])) {
    ...
    if ($submission == "approved") {
        $updateSubmission = $UsersObjEdit->update("submissions", array(
            "status" => "approved"
        ));
        if (!empty($updateSubmission)) {
            header("location: index.php?RequestFarward=ManageSubmissions&condition=approved");
        }
    } else if ($submission == "declined") {
        $updateSubmission = $UsersObjEdit->update("submissions", array(
            "status" => "declined"
        ));
        if (!empty($updateSubmission)) {
            header("location: index.php?RequestFarward=ManageSubmissions&condition=declined");
        }
    }
}
?>
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="pages/users/users_routes.php?request=AllUsers">All Users</a>
                        <a class="collapse-item" href="pages/users/users_routes.php?request=EditUsers">Edit Users</a>
                        <!-- <a class="collapse-item" href="pages/users/users_routes.php?request=UsersRoles">Users role</a> -->
                        <!-- <a class="collapse-item" href="pages/users/users_routes.php?request=UsersBan">Suspend/ban user</a> -->
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="pages/categories/manage_category.php?request=ManageSubmissions">Manage Categories</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMcqs" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="pages/submissions/submission_routes.php?request=ManageRequests">
                            User Requests
                        </a>
                        <a class="collapse-item" href="pages/submissions/submission_routes.php?request=ManageSubmissions">
                            MCQs Submissions
                        </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseContents" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">All Announcement</a>
                        <a class="collapse-item" href="#">Create Announcement</a>
                        <h6 class="collapse-header">Messages</h6>
                        <a class="collapse-item" href="#">Sent Message</a>
                        <a class="collapse-item" href="#">Inbox</a>
                        <h6 class="collapse-header">Notifications & Alerts</h6>
                        <a class="collapse-item" href="#">Push Notifications</a>
                        <a class="collapse-item" href="#">Email Alerts</a>
                        <a class="collapse-item" href="#">System Notifications</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseAdds" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <a class="collapse-item" href="#">Logo & Branding</a>
                        <a class="collapse-item" href="#">Landing Page Settings</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid mb-0">
                    ...
                    if (isset($_GET['RequestFarward'])) {
                        ...
                        if ($farward_request == 'AllUsers') {
                            include('pages/users/totalUsers.php');
                        }

                        if ($farward_request == 'EditUsers') {
                            include('pages/users/total_users_edit.php');
                        }

                        if ($farward_request == 'ManageSubmissions') {
                            include('pages/submissions/submission_manage.php');
                        }

                        if ($farward_request == 'ManageRequests') {
                            include('pages/submissions/request_management.php');
                        }
                    } else {
                    ?>
                        <!-- Page Heading -->
